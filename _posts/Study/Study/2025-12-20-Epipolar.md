...
![fig1](AI_Basics/CV/Epipolar-1.png){: style="display:block; margin:0 auto; width:50%;"}
...
![fig2](AI_Basics/CV/Epipolar-2.png){: style="display:block; margin:0 auto; width:50%;"}
