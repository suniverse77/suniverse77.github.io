...
![fig3](new/muon-3.png){: style="display:block; margin:0 auto; width:40%;"}

### Muon 알고리즘

Muon의 전체적인 동작 과정은 아래의 Pseudo-code로 요약할 수 있다. $G$는 그라디언트, $B$는 모멘텀 행렬을 의미한다.

![fig4](new/muon-4.png){: style="display:block; margin:0 auto; width:70%;"}
