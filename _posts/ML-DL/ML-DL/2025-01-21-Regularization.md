...
![fig1](AI_Basics/ML/Regularization-1.png){: style="display:block; margin:0 auto; width:50%;"}
...
![fig2](AI_Basics/ML/Regularization-2.png){: style="display:block; margin:0 auto; width:50%;"}

## L1 정규화 vs L2 정규화

정규화 term이 있다면, 아래 그림처럼 패널티 영역 안에서 손실 값이 가장 낮은 지점 (검은색 점)을 찾아야 한다.

![fig3](AI_Basics/ML/Regularization-3.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig4](AI_Basics/ML/Regularization-4.png){: style="display:block; margin:0 auto; width:70%;"}
_[[출처]](https://www.linkedin.com/pulse/intuitive-visual-explanation-differences-between-l1-l2-xiaoli-chen/)_
