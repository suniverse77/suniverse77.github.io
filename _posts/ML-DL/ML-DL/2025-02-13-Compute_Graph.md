...
![fig2](AI_Basics/DL/Backprop-2.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig3](AI_Basics/DL/Backprop-3.png){: style="display:block; margin:0 auto; width:30%;"}
...
![fig4](AI_Basics/DL/Backprop-4.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 4 (Neural Networks and Backpropagation)_
...
![fig5](AI_Basics/DL/Backprop-5.png){: style="display:block; margin:0 auto; width:30%;"}
...
![fig6](AI_Basics/DL/Backprop-6.png){: style="display:block; margin:0 auto; width:30%;"}
...
![fig7](AI_Basics/DL/Backprop-7.png){: style="display:block; margin:0 auto; width:30%;"}
