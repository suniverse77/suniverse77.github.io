...
![fig1](Math/Probability/Gaussian-1.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig2](Math/Probability/Gaussian-2.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig3](Math/Probability/Gaussian-3.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig4](Math/Probability/Gaussian-4.png){: style="display:block; margin:0 auto; width:50%;"}
