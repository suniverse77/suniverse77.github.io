...
![fig1](Math/Probability/MLE-1.png){: style="display:block; margin:0 auto; width:60%;"}
_[[출처]](https://velog.io/@ssokeem/STATS-MLE)_

아래의 경우, 가우시안 분포의 평균과 관측값의 평균이 일치한다. 이 모델에서는 관측값들의 우도가 높게 측정된다.

![fig2](Math/Probability/MLE-2.png){: style="display:block; margin:0 auto; width:60%;"}
_[[출처]](https://velog.io/@ssokeem/STATS-MLE)_
