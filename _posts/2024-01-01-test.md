...
직교 기저가 중요한 이유는 서로 직교한다는 것이 <span style="background-color:#fff5b1">선형 독립을 자동으로 보장</span>해주기 때문이다.
...
$$
 ...
 $B=\lbrace\mathbf{b}_1,\dots,\mathbf{b}_n\rbrace$를 orthonormal basis로 변환하는 방법에는 크게 2가지가 있다.
