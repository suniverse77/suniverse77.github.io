...
![fig3](cs231n/06-3.png){: style="display:block; margin:0 auto; width:100%;"}
_[[그림 출처]](https://blog.csdn.net/weixin_38346042/article/details/131882490)_
...
![fig4](cs231n/06-4.png){: style="display:block; margin:0 auto; width:100%;"}
_[[그림 출처]](https://blog.csdn.net/weixin_38346042/article/details/131882490)_
...
![fig5](cs231n/06-5.png){: style="display:block; margin:0 auto; width:100%;"}
_[[그림 출처]](https://blog.csdn.net/weixin_38346042/article/details/131882490)_
...
- **Batch Normalization**: 배치 내에서 각 feature 별로 정규화를 수행한다.
...
![fig12](cs231n/06-12.png){: style="display:block; margin:0 auto; width:100%;"}

### VGGNet

![fig13](cs231n/06-13.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig17](cs231n/06-17.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig18](cs231n/06-18.png){: style="display:block; margin:0 auto; width:100%;"}
...
각 RGB 채널의 평균과 표준편차를 계산해 normalizaiton
...
![fig23](cs231n/06-23.png){: style="display:block; margin:0 auto; width:100%;"}

### Random crops and scales

이미지의 상대적 해상도를 보존?

![fig24](cs231n/06-24.png){: style="display:block; margin:0 auto; width:100%;"}

### Color Jitter

대비와 밝기를 랜덤

![fig25](cs231n/06-25.png){: style="display:block; margin:0 auto; width:100%;"}

### Cutout

검은색이나 회색 상자를 씌움

![fig26](cs231n/06-26.png){: style="display:block; margin:0 auto; width:100%;"}
