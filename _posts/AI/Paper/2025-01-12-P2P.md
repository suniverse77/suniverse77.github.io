...
<br>
![fig0](/assets/images/paper/p2p-0.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig1](/assets/images/paper/p2p-1.png){: style="display:block; margin:0 auto; width:100%;"}
<br>
...
![fig2](/assets/images/paper/p2p-2.png){: style="display:block; margin:0 auto; width:100%;"}
<br>
...
![fig3](/assets/images/paper/p2p-3.png){: style="display:block; margin:0 auto; width:100%;"}
<br>
...
![fig4](/assets/images/paper/p2p-4.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig5](/assets/images/paper/p2p-5.png){: style="display:block; margin:0 auto; width:100%;"}
<br>
Attention injection이 적을수록 원본 이미지의 구조를 보존하지 못하고, 많을수록 원본 이미지의 구조에 제약을 많이 받는다.

---

![fig6](/assets/images/paper/p2p-6.png){: style="display:block; margin:0 auto; width:100%;"}
<br>
원래 프롬프트에 단어를 추가함으로써 local edit과 global modification을 수행할 수 있다.

---

![fig7](/assets/images/paper/p2p-7.png){: style="display:block; margin:0 auto; width:100%;"}
<br>
