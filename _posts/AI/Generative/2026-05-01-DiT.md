...
![fig1](/assets/images/AI/Generative/DiT-1.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig2](/assets/images/AI/Generative/DiT-2.png){: style="display:block; margin:0 auto; width:50%;"}
