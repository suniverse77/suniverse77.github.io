...
![fig0](AI/Transformer/ViT-0.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig1](AI/Transformer/ViT-1.png){: style="display:block; margin:0 auto; width:80%;"}
...
![fig2](AI/Transformer/ViT-2.png){: style="display:block; margin:0 auto; width:50%;"}
_출처: [An Image is Worth 16X16 Words:
Transformers for Image Recognition at Scale](https://arxiv.org/abs/2010.11929)_
...
![fig3](AI/Transformer/ViT-3.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig4](AI/Transformer/ViT-4.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: [An Image is Worth 16X16 Words:
Transformers for Image Recognition at Scale](https://arxiv.org/abs/2010.11929)_
