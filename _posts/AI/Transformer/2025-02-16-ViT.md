...
![fig1](/assets/images/AI/Transformer/ViT-1.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig2](/assets/images/AI/Transformer/ViT-2.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig3](/assets/images/AI/Transformer/ViT-3.png){: style="display:block; margin:0 auto; width:50%;"}
...
![fig4](/assets/images/AI/Transformer/ViT-4.png){: style="display:block; margin:0 auto; width:100%;"}

최종적으로 **ViT Encoder**에서는 총 $L$번의 $[\text{Norm}\to\text{Multi-Head Attn}\to\text{Norm}\to\text{MLP}]$ 과정을 거쳐, <span style="background-color:#fff5b1">패치들 간의 관계를 반영한 contextual feature를 출력</span>한다.

![fig5](/assets/images/AI/Transformer/ViT-5.png){: style="display:block; margin:0 auto; width:80%;"}
...
![fig6](/assets/images/AI/Transformer/ViT-6.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig7](/assets/images/AI/Transformer/ViT-7.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig8](/assets/images/AI/Transformer/ViT-8.png){: style="display:block; margin:0 auto; width:60%;"}
