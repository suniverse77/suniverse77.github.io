...
![fig3](AI/Transformer/Swin_Transformer-2.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig7](AI/Transformer/Swin_Transformer-7.png){: style="display:block; margin:0 auto; width:80%;"}
...
이러한 Patch Merging을 통해 계층적(Hierarchical) scale을 가진 패치는 다양한 크기의 객체를 포착할 수 있게 된다.
