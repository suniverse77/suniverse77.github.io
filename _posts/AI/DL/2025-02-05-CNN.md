...
![fig1](cs231n/cnn/1-1.png){: style="display:block; margin:0 auto; width:90%;"}
...
![fig2](cs231n/cnn/1-2.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig3](cs231n/cnn/1-3.png){: style="display:block; margin:0 auto; width:60%;"}

FC layer에서 가중치의 행마다 1개의 bias가 존재하였고, Convolution Layer에서는 필터 하나마다 1개의 bias가 존재한다.

![fig4](cs231n/cnn/1-4.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig5](cs231n/cnn/1-5.png){: style="display:block; margin:0 auto; width:60%;"}

내적은 선형 연산자이다. CNN에서 사용하는 컨볼루션 연산도 일종의 내적이기 때문에 여러 layer를 쌓아도 여전히 선형 연산자이다. 따라서 선형 분류기에서처럼 컨볼루션 연산 사이에도 활성 함수를 추가해야 한다.

![fig6](cs231n/cnn/1-6.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig7](cs231n/cnn/1-7.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig8](cs231n/cnn/1-8.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig9](cs231n/cnn/1-9.png){: style="display:block; margin:0 auto; width:100%;"}
