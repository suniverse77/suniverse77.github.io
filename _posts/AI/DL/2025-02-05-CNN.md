...
![fig7](dl/cnn/1-7.png){: style="display:block; margin:0 auto; width:30%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig9](dl/cnn/1-9.png){: style="display:block; margin:0 auto; width:80%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig10](dl/cnn/1-10.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_

기본적으로 연산 후 출력의 크기가 $s=2$인 stride와 동일하지만 추가적인 필터가 필요하지 않기 때문에 컴퓨팅 비용이 저렴하다.

![fig11](dl/cnn/1-11.png){: style="display:block; margin:0 auto; width:70%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig12](dl/cnn/1-12.png){: style="display:block; margin:0 auto; width:80%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
