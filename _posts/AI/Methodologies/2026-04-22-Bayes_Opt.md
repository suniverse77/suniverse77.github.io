...
<br>
이 <span style="background-color:#fff5b1">개선량의 기댓값을 구하는 것</span>이 EI다.
...
![fig1](/assets/images/AI/Methodologies/Bayes_Opt-1.png){: style="display:block; margin:0 auto; width:90%;"}
