...
![fig1](/assets/images/AI_Basics/DL/Train-1.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig2](/assets/images/AI_Basics/DL/Train-2.png){: style="display:block; margin:0 auto; width:100%;"}
_출처: Stanford CS231n, Lecture 6 (CNN Architectures)_
...
![fig3](/assets/images/AI_Basics/DL/Train-3.png){: style="display:block; margin:0 auto; width:100%;"}
_출처: Stanford CS231n, Lecture 6 (CNN Architectures)_
...
![fig4](/assets/images/AI_Basics/DL/Train-4.png){: style="display:block; margin:0 auto; width:40%;"}
...
![fig5](/assets/images/AI_Basics/DL/Train-5.png){: style="display:block; margin:0 auto; width:40%;"}
...
![fig6](/assets/images/AI_Basics/DL/Train-6.png){: style="display:block; margin:0 auto; width:40%;"}
...
![fig7](/assets/images/AI_Basics/DL/Train-7.png){: style="display:block; margin:0 auto; width:40%;"}

### Linear Warmup

초기에 선형적으로 learning rate를 증가시킨 후 cosine 또는 invert sqrt 방법을 따라가는 방식이다.

![fig8](/assets/images/AI_Basics/DL/Train-8.png){: style="display:block; margin:0 auto; width:40%;"}
