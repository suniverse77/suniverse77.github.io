...
![fig1](AI_Basics/CV/CNN-1.png){: style="display:block; margin:0 auto; width:90%;"}
...
![fig2](AI_Basics/CV/CNN-2.png){: style="display:block; margin:0 auto; width:70%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig3](AI_Basics/CV/CNN-3.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_

FC layer에서 가중치의 행마다 1개의 bias가 존재하였고, Convolution Layer에서는 필터 하나마다 1개의 bias가 존재한다.

![fig4](AI_Basics/CV/CNN-4.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig5](AI_Basics/CV/CNN-5.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_

내적은 선형 연산자이다. CNN에서 사용하는 컨볼루션 연산도 일종의 내적이기 때문에 여러 layer를 쌓아도 여전히 선형 연산자이다. 따라서 선형 분류기에서처럼 컨볼루션 연산 사이에도 활성 함수를 추가해야 한다.

![fig6](AI_Basics/CV/CNN-6.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig7](AI_Basics/CV/CNN-7.png){: style="display:block; margin:0 auto; width:30%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig8](AI_Basics/CV/CNN-8.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig9](AI_Basics/CV/CNN-9.png){: style="display:block; margin:0 auto; width:80%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig10](AI_Basics/CV/CNN-10.png){: style="display:block; margin:0 auto; width:60%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_

기본적으로 연산 후 출력의 크기가 $s=2$인 stride와 동일하지만 추가적인 필터가 필요하지 않기 때문에 컴퓨팅 비용이 저렴하다.

![fig11](AI_Basics/CV/CNN-11.png){: style="display:block; margin:0 auto; width:70%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
...
![fig12](AI_Basics/CV/CNN-12.png){: style="display:block; margin:0 auto; width:80%;"}
_출처: Stanford CS231n, Lecture 5 (Image Classification with CNNs)_
