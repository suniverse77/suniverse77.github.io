...
![fig1](/assets/images/AI/ML-DL/Model_Train-1.png){: style="display:block; margin:0 auto; width:80%;"}
...
![fig2](/assets/images/AI/ML-DL/Model_Train-2.png){: style="display:block; margin:0 auto; width:70%;"}
