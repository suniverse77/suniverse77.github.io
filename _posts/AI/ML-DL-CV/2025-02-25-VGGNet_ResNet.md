...
![fig12](/assets/images/AI_Basics/CV/VGGNet_ResNet-1.png){: style="display:block; margin:0 auto; width:80%;"}
...
![fig13](/assets/images/AI_Basics/CV/VGGNet_ResNet-2.png){: style="display:block; margin:0 auto; width:80%;"}
...
![fig14](/assets/images/AI_Basics/CV/VGGNet_ResNet-3.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig15](/assets/images/AI_Basics/CV/VGGNet_ResNet-4.png){: style="display:block; margin:0 auto; width:100%;"}

항등함수 (Identity Function)를 넣으면 모델을 최소한 얕은 모델만큼 좋아야한다. 

![fig16](/assets/images/AI_Basics/CV/VGGNet_ResNet-5.png){: style="display:block; margin:0 auto; width:100%;"}

이를 이용해 항등 함수를 쉽게 학습할 수 있도록 skip connection을 추가하였다.

![fig17](/assets/images/AI_Basics/CV/VGGNet_ResNet-6.png){: style="display:block; margin:0 auto; width:80%;"}
...
![fig18](/assets/images/AI_Basics/CV/VGGNet_ResNet-7.png){: style="display:block; margin:0 auto; width:80%;"}
