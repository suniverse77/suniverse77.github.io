---
title: "[딥러닝] MLP (Multi-Layer Perceptron)"
...
![fig1](/assets/images/AI/ML-DL/MLP-1.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig2](/assets/images/AI/ML-DL/MLP-2.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig3](/assets/images/AI/ML-DL/MLP-3.png){: style="display:block; margin:0 auto; width:90%;"}
_출처: Stanford CS231n, Lecture 4 (Neural Networks and Backpropagation)_

활성화 함수에는 여러 종류가 있다.

![fig4](/assets/images/AI/ML-DL/MLP-4.png){: style="display:block; margin:0 auto; width:90%;"}
...
![fig5](/assets/images/AI/ML-DL/MLP-5.png){: style="display:block; margin:0 auto; width:80%;"}
_출처: Stanford CS231n, Lecture 2 (Image Classification with Linear Classifiers)_
...
![fig6](/assets/images/AI/ML-DL/MLP-6.png){: style="display:block; margin:0 auto; width:80%;"}
_출처: Stanford CS231n, Lecture 2 (Image Classification with Linear Classifiers)_
...
![fig7](/assets/images/AI/ML-DL/MLP-7.png){: style="display:block; margin:0 auto; width:80%;"}
_출처: Stanford CS231n, Lecture 2 (Image Classification with Linear Classifiers)_
