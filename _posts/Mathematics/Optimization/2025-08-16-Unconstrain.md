...
![fig1](/assets/images/Math/Optimization/Unconstrain-1.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig2](/assets/images/Math/Optimization/Unconstrain-2.png){: style="display:block; margin:0 auto; width:60%;"}
