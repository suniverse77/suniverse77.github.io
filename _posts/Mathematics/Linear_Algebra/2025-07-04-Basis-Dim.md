...
<details>
<summary><font color='#FF0000'><strong>Example:</strong> 기저 구하기</font></summary>
<div markdown="1">
...
![fig1](/assets/images/Mathematics/Linear_Algebra/Basis-Dim-1.png){: style="display:block; margin:0 auto; width:100%;"}
...
<details>
<summary><font color='#FF0000'><strong>Example:</strong> 직교 기저 좌표계에서 임의의 벡터를 기저로 표현</font></summary>
<div markdown="1">
...
<details>
<summary><font color='#FF0000'><strong>Example:</strong> 정규 직교 기저 좌표계에서 임의의 벡터를 기저로 표현</font></summary>
<div markdown="1">
...
<details>
<summary><font color='#FF0000'><strong>Example:</strong> 임의의 벡터를 정규 직교 좌표 공간으로 정사영한 벡터 구하기</font></summary>
<div markdown="1">
...
$$
\mathcal{U}\subseteq \mathcal{V} \implies \text{dim}(\mathcal{U})\leq \text{dim}(\mathcal{V})
\tag{7}
$$
