...
![fig1](/assets/images/Mathematics/Linear_Algebra/SVD-1.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig2](/assets/images/Mathematics/Linear_Algebra/SVD-2.png){: style="display:block; margin:0 auto; width:70%;"}
