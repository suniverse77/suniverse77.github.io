...
![fig1](Math/Linear_Algebra/SVD-1.png){: style="display:block; margin:0 auto; width:50%;"}
...
![fig2](Math/Linear_Algebra/SVD-2.png){: style="display:block; margin:0 auto; width:70%;"}
_[[출처]](https://my-mindpalace.tistory.com/10)_
...
![fig2](Math/Linear_Algebra/SVD-3.png){: style="display:block; margin:0 auto; width:70%;"}
