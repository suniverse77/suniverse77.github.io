...
![fig1](/assets/images/Math/Signal_System/Kalman_Filter2-1.png){: style="display:block; margin:0 auto; width:40%;"}
...
![fig2](/assets/images/Math/Signal_System/Kalman_Filter2-2.png){: style="display:block; margin:0 auto; width:40%;"}
_[[출처: MATLAB]](https://www.youtube.com/watch?v=4OerJmPpkRg)_
...
![fig3](/assets/images/Math/Signal_System/Kalman_Filter2-3.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig4](/assets/images/Math/Signal_System/Kalman_Filter2-4.png){: style="display:block; margin:0 auto; width:100%;"}
...
![fig5](/assets/images/Math/Signal_System/Kalman_Filter2-5.png){: style="display:block; margin:0 auto; width:90%;"}
...
![fig6](/assets/images/Math/Signal_System/Kalman_Filter2-6.png){: style="display:block; margin:0 auto; width:90%;"}
_[[출처: MATLAB]](https://www.youtube.com/watch?v=VFXf1lIZ3p8)_

전체 과정을 그림으로 나타내면 아래와 같다.

![fig7](/assets/images/Math/Signal_System/Kalman_Filter2-7.png){: style="display:block; margin:0 auto; width:90%;"}_출처: [Notes on Kalman Filter (KF, EKF, ESKF, IEKF, IESKF))](https://arxiv.org/abs/2406.06427)_
