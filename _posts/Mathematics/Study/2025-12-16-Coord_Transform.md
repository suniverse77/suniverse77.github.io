...
![fig1](/assets/images/AI_Basics/CV/Coord_Transform-1.png){: style="display:block; margin:0 auto; width:60%;"}
...
![fig2](/assets/images/AI_Basics/CV/Coord_Transform-2.png){: style="display:block; margin:0 auto; width:60%;"}
...
> 
> ![fig3](/assets/images/AI_Basics/CV/Coord_Transform-3.png){: style="display:block; margin:0 auto; width:40%;"}
