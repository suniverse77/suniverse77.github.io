...
![fig1](Mathematics/Probability/PD-1.png){: style="display:block; margin:0 auto; width:70%;"}
...
![fig2](Mathematics/Probability/PD-2.png){: style="display:block; margin:0 auto; width:70%;"}
