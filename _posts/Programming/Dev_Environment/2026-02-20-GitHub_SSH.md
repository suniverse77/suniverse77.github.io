...
3. SSH Key 등록
    ...
    ![fig1](Programming/Dev_Environment/GitHub_SSH-1.png){: style="display:block; margin:0 auto; width:20%;"}

    2. **SSH 등록:** 왼쪽 메뉴의 **SSH and GPG Keys** 클릭하고 **New SSH key** 클릭

    ![fig2](Programming/Dev_Environment/GitHub_SSH-2.png){: style="display:block; margin:0 auto; width:20%;"}
...
2. 깃허브의 `<> Code` 버튼의 SSH 탭에서 `.git` 주소 복사
    ...
    ![fig3](Programming/Dev_Environment/GitHub_SSH-3.png){: style="display:block; margin:0 auto; width:60%;"}
